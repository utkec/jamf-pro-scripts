...
#The point of this script is to output all computers along with the installed app on the computer from your Jamf Pro instance.

#fill in variables for your environment
jssurl="https://INSTANCENAME.jamfcloud.com"
apiUser="ADMIN"
apiPass="PASS"
